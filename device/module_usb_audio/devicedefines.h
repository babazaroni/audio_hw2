...
#ifndef FORBIDDEN_FREQ
#define FORBIDDEN_FREQ 0
#endif
...
#ifndef VENDOR_STR
#ifdef KMI
#define VENDOR_STR               "Keith McMillen Instruments"
#else
...
#define AUDIO_STOP_FOR_DFU_p1       (AUDIO_STOP_FOR_DFU+1)
#define AUDIO_START_FROM_DFU_p1     (AUDIO_START_FROM_DFU+1)
...
#define ID_IT_AUD                1               /* Input terminal: Analog input */
#define ID_OT_USB                22              /* Output terminal: USB streaming */
#define ID_OT_AUD                20              /* Output terminal: Analog output */
