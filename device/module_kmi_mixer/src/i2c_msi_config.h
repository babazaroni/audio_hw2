...
#define I2C_TX_INTERFACE_COUNT  1
...
#define I2C__SCL_PORT          XS1_PORT_1L
#define I2C__SDA_PORT          XS1_PORT_1I

#define I2C_ADDRESS_A   0x40    // local startkit
#define I2C_ADDRESS_B   0x42    // remote startkit
#define I2C_ADDRESS_C   0x20    // the 8051


//#define DEBUG_PORT_DECLARATION port _i2c_debug_port = XS1_PORT_1G;
//#define DEBUG_PORT_WRITE(val) _i2c_debug_port <: val;
#define DEBUG_PORT_DECLARATION
#define DEBUG_PORT_WRITE(val)

#define I2C_TX_INTERFACE_1  0
//#define I2C_TX_INTERFACE_2  1
...
#define SCL_DATA_HALF_PERIOD    450      // 20 = 562k 40=474k 100=321k 200=200k  400=118k
...
#ifdef OLD
#ifndef I2C_MSI_CONFIG_H_
#define I2C_MSI_CONFIG_H_
...
#define I2C_ADDRESS_A   0x3a
#define I2C_ADDRESS_B   0x3c

#endif /* I2C_MSI_CONFIG_H_ */
#endif
